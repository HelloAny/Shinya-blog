  ...
  return (
    <main className="user">
      <section className="user__container">
        ...
        <section className="user__container-summary">{jrsc}</section>
        <hr className="hr" />
              ...
              <a href="https://twitter.com/AmiKara2" rel="noopener noreferrer" target="_blank">
                <svg aria-labelledby="pageFooter-iconTwitter-title" role="img" width="14" height="14" viewBox="0 0 14 14">
                  ...
                  <use xlinkHref="#icon_twitter">
                    <defs>
                      <svg id="icon_twitter" viewBox="0 0 14 14" fill="#999898"><path d="M13.98 2.27c-.51.25-1.07.42-1.65.49.59-.39 1.05-1 1.26-1.73-.55.36-1.17.62-1.82.76-.52-.61-1.26-.99-2.08-.99-1.58 0-2.87 1.4-2.87 3.13 0 .25.03.48.07.71C4.51 4.51 2.4 3.27.99 1.37c-.25.46-.39 1-.39 1.57 0 1.09.51 2.04 1.27 2.61-.47-.02-.91-.16-1.3-.39v.04c0 1.52.99 2.78 2.3 3.07-.23.07-.49.11-.75.11-.18 0-.36-.02-.54-.06.36 1.24 1.42 2.15 2.68 2.17-.98.84-2.22 1.34-3.56 1.34-.23 0-.46-.02-.68-.04 1.27.89 2.77 1.41 4.39 1.41 5.27 0 8.15-4.77 8.15-8.91 0-.14 0-.27-.01-.41a5.83 5.83 0 0 0 1.43-1.61z"></path></svg>
                    </defs>
                  </use>
                </svg>
              </a>
