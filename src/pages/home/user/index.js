      ...
      <section className="user__container">
        ...
        <section className="user__container-link">
          <section className="user__container-link-layoutOne">
            © 2019-2021{" "}
            <a href="https://www.amikara.com" rel="noopener noreferrer">
              {" "}
              Shinya{" "}
            </a>{" "}
            Blog.
          ...
          <section className="user__container-link-layoutTwo">
            <span className="user__container-link-item">
              ...
              >
                <svg
                  aria-labelledby="pageFooter-iconTwitter-title"
                  role="img"
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
                >
                  ...
                  <use xlinkHref="#icon_twitter">
                    <defs>
                      <svg id="icon_twitter" viewBox="0 0 14 14" fill="#999898">
            ...
            <span className="user__container-link-item">
              ...
              >
                <svg
                  aria-labelledby="pageFooter-iconInstagram-title"
                  role="img"
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
            ...
            <span className="user__container-link-item">
              ...
              >
                <svg
                  aria-labelledby="pageFooter-iconGithub-title"
                  role="img"
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
