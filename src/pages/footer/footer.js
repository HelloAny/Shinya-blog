      ...
      <main className="footer">
        <section className="footer__head">
          <section className="footer__head-left">
            <section className="footer__head-left-summary"> New Object <br /> Welcome Shinya </section>
            <section className="footer__head-left-link">
              <span><a href="https://amikara.com" rel="noopener noreferrer" target="_blank">Blog </a></span>
              <span><a href="https://github.com/HelloAny" rel="noopener noreferrer" target="_blank">GitHub </a> </span>
              <span><a href="https://twitter.com/AmiKara2" rel="noopener noreferrer" target="_blank">Twitter </a> </span>
              <span><a href="https://www.zhihu.com/people/ai-yi-zhu-53" rel="noopener noreferrer" target="_blank">ZhiHu </a> </span>
              <span><a href="https://www.instagram.com/amikara_/" rel="noopener noreferrer" target="_blank">Instagram </a> </span>
              <span><a href="https://www.v2ex.com/member/AmiKara" rel="noopener noreferrer" target="_blank">V2EX </a> </span>
            </section>
          </section>
